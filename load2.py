...
for excel_file in csv_files:
    ...
    for column_name, data_type in column_data_types.items():
        # Enclose column name with square brackets to avoid syntax error
    ...
    for index, row in df.iterrows():
        ...
        # Enclose column names with square brackets to avoid syntax error
        insert_query = f"BULK INSERT {table_name} FROM '{os.path.join(csv_dir, excel_file)}' WITH (FORMAT = 'CSV', FIRSTROW = 2, FIELDTERMINATOR = ',', ROWTERMINATOR = '\n', TABLOCK)"
